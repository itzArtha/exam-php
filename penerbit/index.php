      ...
      <section class="pt-4 bg-success">
         <div>
            <div class="container">
               ...
               <p class="lead text-light">MENAMPILKAN DAFTAR PENERBIT DALAM FORMAT TABEL</p>
            </div>
         </div>
         ...
         <table class="table table-bordered table-striped">
            ...
            <!-- PHP untuk looping data menggunakan while -->
               ...
               <tr>
                  ...
                  <td><?= $data['alamat'] ?></td>
                  <td>
                     <img src="../penerbit/<?= $status ?>" alt="">
                  </td>
                  <td width="150">
                     <a href="../penerbit/190030509-view.php?id=<?= $data['id_penerbit'] ?>" type="button" class="btn btn-success"><i class="fa fa-pencil"></i></a>
