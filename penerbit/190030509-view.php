...
<html>
   ...
   <body>
      ...
      <section class="pt-4 bg-success">
         <div>
            <div class="container">
               ...
               <p class="lead text-light">MENAMPILKAN DATA PENERBIT YANG AKAN DI-UPDATE</p>
            </div>
         </div>
      ...
      <div class="container my-5">
         ...
         <form action="190030509-update.php?id=<?= $data['id_penerbit'] ?>" onSubmit="return cek_form(this)" method="POST">
      ...
      function cek_form(frm) {
         ...
         if (frm.nama.value == "") {
            ...
            // Mengembalikan data berupa true agar bisa submit
            return true;
         }
      }
      </script>
